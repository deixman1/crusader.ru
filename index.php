...
<body>
	<div class="bg black" id="bg-header-first"></div>
	<div class="bg black opacity" id="bg-header-second"></div>
	<div class="bg" id="bg-header-third"></div>
	<div class="bg" id="bg-content-first"></div>
	<div id="wrapper">
		<div id="header">
			<div class="row">
		...
		<div id="content">
			...
			<div class="row center textWhite" style="font-size: 24px">
				<span>Полная версия сайта закрыта на техническое обслуживание. Приносим свои извинения.</span>
			</div>
			<div class="row center textWhite" style="font-size: 14px">
				<span>2017 Crusader Team</span>
			</div>
		</div>
	</div>
</body>
